        ...
        <div id="title">
            ...
            <span class="text-home">
                ...
                <svg class="svg-letters-home big-800" height="50" width="0">
                    ...
                    <text class="svg-letters-blue" x="0" y="90">A</text>

                    <text class="svg-letters-red" x="10" y="90">A</text>

                </svg>

                <svg class="svg-letters-home little-800" height="50" width="0">

                    <text class="svg-letters-blue" x="0" y="50">A</text>

                    <text class="svg-letters-red" x="5" y="50">A</text>

                </svg>



                <span class="text-home-lex"></span>lex
...
<div id="section-contact-big-container">
